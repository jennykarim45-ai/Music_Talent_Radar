...
if st.session_state.active_page == "Vue d'ensemble":
    ...
    # ═══════════════════════════════════════════════════════════
    # GRAPHIQUE : COLLECTES QUOTIDIENNES (AIRES EMPILÉES)
    # ═══════════════════════════════════════════════════════════
...
# ==================== TAB 7: À PROPOS ====================
    ...
    Découvrez mes créations musicales sur SoundCloud :
    </p>
    """, unsafe_allow_html=True)
    ...
    morceaux_soundcloud = [
        ...
        ("🎵 Je Suis", "https://soundcloud.com/jenny/qui-suis-je"),
        ("🎵 L'Humain", "https://soundcloud.com/jenny/je-ne-comprends-pas-lhumain"),
    ]
                ...
                try:
                    ...
                    with col_cm:
                        ...
                        fig_cm.update_layout(
                            xaxis_title="<b>Prédiction</b>",
                            yaxis_title="<b>Réalité</b>",
                            plot_bgcolor='#000000',
                            paper_bgcolor='#000000',
                            font=dict(color='#FFD700', size=13, family='Arial'),
                            height=350,
